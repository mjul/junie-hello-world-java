...
/**
 * A friendly error controller that renders the error page and ensures a proper 5xx status when the
 * error path is accessed directly. This also avoids exposing internal details and falls back to a
 * generic message.
 */
@Controller
